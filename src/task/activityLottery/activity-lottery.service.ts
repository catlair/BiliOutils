...
import { ActivityLotteryStatus } from './activity-lottery.emum';
...
import * as activityRequest from './activity-lottery.request';
import { addAndDelBangumiFollow } from '@/service/bangumi.service';
